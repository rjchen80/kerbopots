        ...
        for action in self.actions:
            ...
            if a[0] == "RAISE":
                ...
                if stackSizes[id]-callvalue == 0 or stackSizes[id] == 0:
                    ...
                    print stackSizes
                try:
                    raiseratio = (raisevalue-callvalue)/(stackSizes[id]-callvalue+1e-5)*2 + callvalue/stackSizes[id] + (raisevalue-callvalue)/potSize + (raisevalue-callvalue)*2/stackSizes[myId]
                except ValueError:
                    print self.actions
            ...
            if a[0] == "BET":
                ...
                if stackSizes[id] == 0:
                    ...
                    print stackSizes
                try:
                    betratio = betvalue / stackSizes[id] + betvalue / potSize + betvalue*2 / stackSizes[myId]
                except ValueError:
                    print self.actions
